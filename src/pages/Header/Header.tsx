          ...
          <div className="container mx-auto flex justify-between items-center p-5">
            ...
            <nav className="hidden md:flex flex-wrap items-center text-lg justify-center space-x-6">
              ...
              <button
                ...
                className="inline-flex items-center bg-indigo-600 border-0 py-2 px-4 focus:outline-none hover:bg-indigo-700 text-white rounded-full text-base shadow-lg transition-all"
              >
